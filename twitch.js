$(document).ready(function () {
    ...
    $.when.apply($, promise).then(function () { // when all outer ajax promises fulfilled, i.e. ajax returns good data.
        promise2 = $.map(promise2, function (p) { // map promise of inner promises array to resolve after it has been called
